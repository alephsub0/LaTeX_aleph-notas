...
\begin{changelog}[author=Andés Merino,
    sectioncmd=\section]
    % version 2.0.1
    \begin{version}[v=2.0.1,
        date=2024-04-21]
        \changed
        \item Se actualiza el archivo \texttt{README.md} y la licencia del paquete.
        \fixed 
        \item Se arregla un problema con el espacio de los títulos de secciones.
    \end{version}
    % version 2.0
    \begin{version}[v=2.0,
        date=2023-11-27]
