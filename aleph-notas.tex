...
\begin{itemize}
    \item[\textbf{1.0}] (2020-01-07) \textit{Primera versión estable}
    \item[\textbf{1.1}] (2020-08-14)
        \begin{itemize}
    ...
    \item[\textbf{2.0}] (2023-11-27)
        \begin{itemize}
            ...
            \item Se modifca el diseño del encabezado y los encabezados y pies de páginas
        \end{itemize}
\end{itemize}
